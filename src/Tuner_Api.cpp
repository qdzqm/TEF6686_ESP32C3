...
const Radio_AreaConfigDef Radio_AreaConfig={
    ...
    10800,        8750,      1710,       531,         FM_Step_100k,        FM_Step_100k,                 9,                  9};
	
const FreqBaundDef FreqBaundConfig[MaxBandNum]={		
   /*0-FM1,1-FM2,2-FM3,3-LW,4-MW,5-SW*/
    {8750,10800},{531,1710},{2300,27000}};    
...
{
	return (band==FM_BAND)? Radio_AreaConfig.FM_ManualSeekStep : Radio_AreaConfig.AM_ManualSeekStep;
}
/*-----------------------------------------------------------------------
...
{ 
      return ((Radio_CurrentBand==FM_BAND)?1:0 )	;
}
...
void Radio_CheckStation(void)
{
	...
	uint8_t fm = (Radio_CurrentBand==FM_BAND);
	switch(CheckIfStep)
	{
